...
backward compatibility, and security challenges that protocols
...
.. [#] In principle, this P4Info file is not strictly required, as the
       ...
       format, which is straightforward to parse using a protobuf library.
